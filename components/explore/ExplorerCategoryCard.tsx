...
> = {
  pentateuch: {
    ...
    veil: "bg-[linear-gradient(180deg,rgba(18,10,4,0.04),rgba(18,10,4,0.14)_28%,rgba(10,7,4,0.28)_62%,rgba(8,6,4,0.52))]",
    ...
    textVeil: "bg-[radial-gradient(circle_at_18%_30%,rgba(0,0,0,0.34),transparent_34%),linear-gradient(90deg,rgba(5,4,3,0.52),rgba(5,4,3,0.20)_42%,transparent_72%),linear-gradient(180deg,transparent_0%,rgba(5,4,3,0.12)_48%,rgba(5,4,3,0.42)_100%)]",
    artClass:
  ...
  historical: {
    ...
    veil: "bg-[linear-gradient(180deg,rgba(7,15,30,0.04),rgba(7,15,30,0.14)_26%,rgba(6,11,22,0.26)_60%,rgba(5,8,16,0.50))]",
    ...
    textVeil: "bg-[radial-gradient(circle_at_18%_28%,rgba(0,0,0,0.32),transparent_34%),linear-gradient(90deg,rgba(4,7,12,0.54),rgba(4,7,12,0.22)_44%,transparent_72%),linear-gradient(180deg,transparent_0%,rgba(4,7,12,0.10)_48%,rgba(4,7,12,0.42)_100%)]",
    artClass:
  ...
  wisdom: {
    ...
    veil: "bg-[linear-gradient(180deg,rgba(8,8,16,0.04),rgba(8,8,16,0.12)_22%,rgba(8,8,16,0.22)_54%,rgba(6,5,11,0.46))]",
    ...
    textVeil: "bg-[radial-gradient(circle_at_18%_28%,rgba(0,0,0,0.34),transparent_34%),linear-gradient(90deg,rgba(6,5,11,0.56),rgba(6,5,11,0.24)_44%,transparent_72%),linear-gradient(180deg,transparent_0%,rgba(6,5,11,0.10)_48%,rgba(6,5,11,0.42)_100%)]",
    artClass:
  ...
  major_prophets: {
    ...
    veil: "bg-[linear-gradient(180deg,rgba(10,7,18,0.05),rgba(10,7,18,0.14)_24%,rgba(10,7,18,0.24)_58%,rgba(7,5,12,0.50))]",
    ...
    textVeil: "bg-[radial-gradient(circle_at_18%_28%,rgba(0,0,0,0.34),transparent_34%),linear-gradient(90deg,rgba(7,5,12,0.58),rgba(7,5,12,0.24)_44%,transparent_72%),linear-gradient(180deg,transparent_0%,rgba(7,5,12,0.12)_48%,rgba(7,5,12,0.44)_100%)]",
    artClass:
  ...
  minor_prophets: {
    ...
    veil: "bg-[linear-gradient(180deg,rgba(5,12,13,0.04),rgba(5,12,13,0.12)_24%,rgba(5,12,13,0.24)_58%,rgba(4,7,8,0.48))]",
    ...
    textVeil: "bg-[radial-gradient(circle_at_18%_28%,rgba(0,0,0,0.30),transparent_34%),linear-gradient(90deg,rgba(4,7,8,0.54),rgba(4,7,8,0.22)_44%,transparent_72%),linear-gradient(180deg,transparent_0%,rgba(4,7,8,0.10)_48%,rgba(4,7,8,0.40)_100%)]",
    artClass:
  ...
  gospels: {
    ...
    veil: "bg-[linear-gradient(180deg,rgba(16,12,5,0.04),rgba(16,12,5,0.12)_22%,rgba(10,8,4,0.22)_56%,rgba(8,6,4,0.46))]",
    ...
    textVeil: "bg-[radial-gradient(circle_at_18%_28%,rgba(0,0,0,0.32),transparent_34%),linear-gradient(90deg,rgba(8,6,4,0.56),rgba(8,6,4,0.22)_44%,transparent_72%),linear-gradient(180deg,transparent_0%,rgba(8,6,4,0.10)_48%,rgba(8,6,4,0.40)_100%)]",
    artClass:
  ...
  acts: {
    ...
    veil: "bg-[linear-gradient(180deg,rgba(14,9,4,0.04),rgba(14,9,4,0.12)_24%,rgba(8,6,4,0.22)_58%,rgba(7,5,4,0.46))]",
    ...
    textVeil: "bg-[radial-gradient(circle_at_18%_28%,rgba(0,0,0,0.32),transparent_34%),linear-gradient(90deg,rgba(7,5,4,0.56),rgba(7,5,4,0.22)_44%,transparent_72%),linear-gradient(180deg,transparent_0%,rgba(7,5,4,0.10)_48%,rgba(7,5,4,0.40)_100%)]",
    artClass:
  ...
  pauline_epistles: {
    ...
    progress: "bg-gradient-to-r from-sky-200 via-blue-300 to-indigo-400",
    veil: "bg-[linear-gradient(180deg,rgba(6,11,20,0.04),rgba(6,11,20,0.12)_24%,rgba(6,9,14,0.24)_58%,rgba(5,7,11,0.50))]",
    ...
    textVeil: "bg-[radial-gradient(circle_at_18%_28%,rgba(0,0,0,0.32),transparent_34%),linear-gradient(90deg,rgba(5,7,11,0.56),rgba(5,7,11,0.22)_44%,transparent_72%),linear-gradient(180deg,transparent_0%,rgba(5,7,11,0.10)_48%,rgba(5,7,11,0.42)_100%)]",
    artClass:
  ...
  general_epistles: {
    ...
    veil: "bg-[linear-gradient(180deg,rgba(7,11,16,0.04),rgba(7,11,16,0.12)_24%,rgba(6,8,12,0.24)_58%,rgba(5,6,10,0.48))]",
    ...
    textVeil: "bg-[radial-gradient(circle_at_18%_28%,rgba(0,0,0,0.32),transparent_34%),linear-gradient(90deg,rgba(5,6,10,0.54),rgba(5,6,10,0.22)_44%,transparent_72()),linear-gradient(180deg,transparent_0%,rgba(5,6,10,0.10)_48%,rgba(5,6,10,0.40)_100%)]",
    artClass:
  ...
  apocalyptic: {
    ...
    veil: "bg-[linear-gradient(180deg,rgba(11,4,7,0.05),rgba(11,4,7,0.14)_24%,rgba(7,3,5,0.24)_58%,rgba(5,3,5,0.54))]",
    ...
    textVeil: "bg-[radial-gradient(circle_at_18%_28%,rgba(0,0,0,0.34),transparent_34%),linear-gradient(90deg,rgba(5,3,5,0.58),rgba(5,3,5,0.24)_44%,transparent_72%),linear-gradient(180deg,transparent_0%,rgba(5,3,5,0.12)_48%,rgba(5,3,5,0.44)_100%)]",
    artClass:
  ...
  return (
    <Link href={href} className="block">
      ...
      >
        ...
        <div className={`absolute inset-0 ${visual.textVeil}`} />
