  ...
  return (
    <div className="min-h-screen bg-[#0B0F1A] text-white px-4 py-16">
      <div className="max-w-5xl mx-auto flex flex-col items-center">
        ...
        <div className="w-full bg-[#121826] border border-neutral-800 rounded-xl p-5">
          ...
          <button
            ...
            className="mt-4 w-full bg-gray-700 text-white hover:bg-neutral-600 transition py-2 rounded-lg font-semibold active:scale-95"
          >
            Continue with Pro
          </button>
        </div>

        <div className="relative w-full bg-[#121826] border-2 border-green-500 rounded-xl p-5 scale-105 shadow-[0_0_20px_rgba(34,197,94,0.45)]">
