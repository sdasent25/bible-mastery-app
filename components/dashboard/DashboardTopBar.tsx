  ...
  return (
    <section className="ba-dashboard-topbar hidden lg:block">
      <div className="flex items-center gap-1.75">
        <div className="flex min-w-0 items-center gap-1.75 pr-0.5 xl:min-w-[10.4rem]">
          <span className="ba-header-brand-mark">
            {renderNavIcon("brand", "h-[1rem] w-[1rem]")}
          </span>
          <div className="min-w-0">
            <div className="ba-serif-brand ba-font-display truncate text-[0.92rem] text-[#f5e7c7]">
              Bible Athlete
            </div>
        ...
        <div className="flex min-w-0 flex-1 items-center gap-1.75 rounded-[0.95rem] border border-amber-200/10 bg-white/[0.02] px-2 py-1.2">
          <div className="ba-level-shield flex h-9.5 w-9.5 shrink-0 items-center justify-center rounded-[0.95rem] border border-amber-300/24 text-amber-50 shadow-[0_0_18px_rgba(251,191,36,0.12)]">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-end justify-between gap-2">
              <div className="min-w-0">
                <div className="ba-font-ui text-[0.54rem] font-medium text-[#d9cdbd]/78">Athlete Level</div>
                <div className="ba-font-ui truncate whitespace-nowrap text-[0.8rem] font-semibold tracking-[0.01em] text-[#f2e8d6]">
                  {xpToNextLevel.toLocaleString()} XP <span className="text-[#d7cab9]/74">to next level</span>
                </div>
              </div>
            </div>
            <div className="ba-progress-track mt-1 h-[3px]">
              <div
            ...
            <div className="ba-text-section-label mt-0.75 flex items-center justify-between text-[0.46rem] text-white/36">
        ...
        <div className="flex items-center gap-1.75 rounded-[0.95rem] border border-amber-200/10 bg-[linear-gradient(180deg,rgba(14,19,30,0.94),rgba(7,10,17,0.96))] px-2.15 py-1.4 shadow-[inset_0_1px_0_rgba(255,255,255,0.04),0_0_22px_rgba(251,146,60,0.08)]">
          <span className="inline-flex h-8 w-8 items-center justify-center rounded-full border border-amber-300/18 bg-[radial-gradient(circle_at_top,rgba(255,198,92,0.22),rgba(42,20,7,0.98))] text-amber-100 shadow-[0_0_18px_rgba(251,146,60,0.14)]">
            {renderNavIcon("sun", "h-[1rem] w-[1rem]")}
          </span>
          <div className="min-w-0">
            <div className="ba-font-ui text-[0.52rem] font-semibold uppercase tracking-[0.12em] text-[#f5c96f]">
              Streak
            </div>
            <div className="ba-font-ui text-[0.78rem] font-semibold text-[#f7ecda]">
