...
export default function FlashcardList({
  ...
  return (
    <div className="grid gap-4">
      {flashcards.map((card) => {
        const memoryStage = getMemoryStage(card)
        ...
        return (
          ...
          >
            ...
            <div className="mt-5 rounded-[1.2rem] border border-white/10 bg-slate-950/45 p-4">
              ...
              <div className="mt-4 h-2 overflow-hidden rounded-full bg-white/10">
                <div
                  ...
                  style={{ width: `${memoryStage.progressValue}%` }}
                />
              </div>
            </div>
            ...
            <div className="mt-5 hidden grid-cols-2 gap-3 rounded-[1.25rem] border border-white/10 bg-slate-950/50 p-4 text-sm md:grid xl:grid-cols-4">
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-500">Stage</p>
                <p className="mt-2 font-semibold text-white">{memoryStage.stageLabel}</p>
              </div>
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.2em] text-slate-500">Next Drill</p>
                <p className="mt-2 font-semibold text-white">{memoryStage.nextDrill}</p>
              </div>
              <div>
