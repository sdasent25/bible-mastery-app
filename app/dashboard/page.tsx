    ...
    <div className="flex min-h-screen bg-slate-950 text-white relative overflow-hidden">
      ...
      <div className="relative z-10 flex-1 px-10 py-8">
        <div className="max-w-5xl">
          ...
          {nextSegment && (
            <div className="relative bg-slate-900 p-8 rounded-2xl shadow-xl shadow-[0_0_40px_rgba(59,130,246,0.2)] mb-6 border border-white/5">
              <div className="absolute -top-10 left-1/2 -translate-x-1/2">
                <Flame state={streak >= 3 ? "super" : "idle"} size={96} />
              </div>
