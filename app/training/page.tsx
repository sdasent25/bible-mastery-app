          ...
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
            {days.map((day) => {
              ...
              return (
                <article
                  key={day.day}
                  className="rounded-[1.65rem] border border-white/10 bg-[linear-gradient(180deg,rgba(16,22,36,0.96),rgba(8,11,20,0.98))] p-5 shadow-[0_20px_60px_rgba(0,0,0,0.22)]"
                >
                  ...
                  <h3 className="mt-5 text-2xl font-black text-white">{day.reference}</h3>
                    ...
                    <Link
                      ...
                      className={`inline-flex rounded-full px-4 py-2 text-sm font-semibold transition ${
                        lockedForFree
                          ...
                          : "bg-amber-200 text-[#2c1600] hover:scale-[1.01]"
                      }`}
                    >
